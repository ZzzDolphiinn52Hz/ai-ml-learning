...
% =========================
\title{
    \textbf{Tài liệu học tập ANN8}\\
    \large Nguyên nhân và cách xử lý Underfitting, Overfitting
}
...
% ==========================================================
\chapter{Ôn lại Underfitting và Overfitting}
...
% ==========================================================
\chapter{Ví dụ Underfitting và Overfitting trong phân loại}

\section{Mô tả bài toán phân loại}
...
\section{Underfitting trong phân loại}
...
\section{Overfitting trong phân loại}
...
% ==========================================================
\chapter{Ví dụ Underfitting và Overfitting trong hồi quy}

\section{Mô tả bài toán hồi quy}
...
\section{Underfitting trong hồi quy}
...
\section{Good fitting trong hồi quy}
...
\section{Overfitting trong hồi quy}
...
% ==========================================================
\chapter{Nguyên nhân gây Underfitting}

\section{Mô hình quá đơn giản}
...
\section{Cách xử lý underfitting}
...
% ==========================================================
\chapter{Nguyên nhân gây Overfitting}

\section{Mô hình quá phức tạp}
...
% ==========================================================
\chapter{Giải pháp cho Overfitting: Đơn giản hóa mô hình}

\section{Giảm độ phức tạp mô hình}
...
% ==========================================================
\chapter{Giải pháp cho Overfitting: Tăng dữ liệu}

\section{Tại sao cần thêm dữ liệu?}
...
\section{Ví dụ nhận diện khuôn mặt}
...
\section{Data augmentation là gì?}
...
\section{Cắt ảnh và dịch cửa sổ}
...
\section{Thay đổi màu sắc và độ sáng}
...
\section{Augmentation phải phù hợp với bài toán}
...
\section{Tác dụng về số lượng dữ liệu}
...
% ==========================================================
\chapter{Train, Validation và Test Set}

\section{Vì sao phải chia dữ liệu?}
...
\section{Vai trò của training set}
...
\section{Vai trò của validation set}
...
% ==========================================================
\chapter{Nguyên tắc sử dụng Test Set}

\section{Không được dùng test set nhiều lần để chỉnh mô hình}
...
\section{Vì sao đây là lỗi nghiêm trọng?}
...
\section{Liên hệ với nghiên cứu khoa học}
...
\section{Nếu lỡ dùng test set thì làm sao?}
...
\section{Ví dụ K-fold cross-validation}
...
\section{Không phải cứ early stopping là mô hình tốt}
...
\section{Một thời điểm trong dropout là gì?}
...
\section{Vì sao dropout giúp giảm overfitting?}
...
\section{Dropout và robust model}
...
\section{Vì sao không dùng dropout khi test?}
...
% ==========================================================
\chapter{Tổng hợp các kỹ thuật xử lý Overfitting}
...
\section{Kỹ thuật nào quan trọng nhất?}
...
\section{Công thức và con số cần nhớ}
...
\section*{Bài tập 1: Nhận diện lỗi mô hình}
...
\section*{Bài tập 2: Chia dữ liệu}
...
\section*{Bài tập 3: Data augmentation}
...
\section*{Bài tập 4: Chọn augmentation phù hợp}
