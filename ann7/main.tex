...
% =========================
\title{
    \textbf{Tài liệu học tập ANN7}\\
    \large Vanishing Gradient, Underfitting và Overfitting
}
...
% ==========================================================
\chapter{Từ lý thuyết huấn luyện đến vấn đề thực tế}

\section{Nhắc lại quá trình huấn luyện}
...
\section{Ba vấn đề chính trong bài ANN7}
...
% ==========================================================
\chapter{Vanishing Gradient}

\section{Vanishing gradient là gì?}
...
\section{Vì sao gradient có thể biến mất?}
...
% ==========================================================
\chapter{Vanishing Gradient và hàm sigmoid}
...
\section{Vấn đề của sigmoid trong mạng sâu}
...
% ==========================================================
\chapter{ReLU và ý tưởng giảm vanishing gradient}
...
\section{Vì sao ReLU giúp giảm vanishing gradient?}
...
% ==========================================================
\chapter{Underfitting và Overfitting}

\section{Bài toán fitting là gì?}
...
\section{Ba trạng thái thường gặp}
...
\section{ fitting trong phân loại}
...
\section{Vì sao phân loại hoàn hảo chưa chắc là tốt?}
...
% ==========================================================
\chapter{Nhiễu dữ liệu và sai số đo lường}

\section{Dữ liệu đo được không hoàn hảo}
...
\section{Liên hệ với overfitting}
...
% ==========================================================
\chapter{Ví dụ hồi quy}

\section{Bài toán hồi quy là gì?}
...
\section{Dữ liệu hồi quy có nhiễu}
...
\section{So sánh classification và regression}
...
% ==========================================================
\chapter{Tổng hợp: Khi nào mô hình học tốt?}

\section{Mô hình học tốt cần cân bằng}
...
\section{Liên hệ với loss bằng 0}
...
\section*{Bài tập 1: Kiểm tra vanishing gradient}
...
\section*{Bài tập 2: Tính đạo hàm sigmoid}
...
\section*{Bài tập 3: Nhận diện underfitting và overfitting}
...
\section*{Bài tập 4: Phân biệt classification và regression}
