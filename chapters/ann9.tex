...
% ==========================================================
\section{Gradient Descent Recap -- Nhắc lại Gradient Descent trong huấn luyện ANN}

\subsection{Mục tiêu của huấn luyện}
...
\subsection{Một vấn đề cần làm rõ}
...
% ==========================================================
\section{Stochastic Gradient Descent (SGD) -- Stochastic Gradient Descent}
...
\subsection{SGD và online learning}
...
\subsection{Đặc điểm: đường đi nhiễu}
...
% ==========================================================
\section{Batch Gradient Descent -- Batch Gradient Descent}
...
\subsection{Vì sao lấy trung bình gradient?}
...
\subsection{Đặc điểm: ổn định hơn SGD}
...
\subsection{Ưu điểm của Batch Gradient Descent}
...
\subsection{Nhược điểm của Batch Gradient Descent}
...
% ==========================================================
\section{Contour Lines \& Local Minima -- Đường đồng mức và cực trị địa phương}

\subsection{Đường đồng mức là gì?}
...
\subsection{Không gian hai biến và giá trị hàm}
...
\subsection{Vì sao SGD có thể tránh cực trị địa phương?}
...
\subsection{Đường đi của mini-batch}
...
\subsection{Vì sao mini-batch được dùng phổ biến?}
...
% ==========================================================
\section{So sánh ba phương pháp Gradient Descent}
...
\subsection{Ba thái cực và giải pháp trung gian}
...
% ==========================================================
\section{Các thuật ngữ quan trọng}

\subsection{Sample, data point và example}
...
% ==========================================================
\section{Cách tính số iteration trong một epoch}
...
\subsection{Trường hợp Batch Gradient Descent}
...
\subsection{Trường hợp Mini-batch Gradient Descent}
...
% ==========================================================
\section{Tại sao Batch GD là hướng dốc nhất còn SGD thì nhiễu?}

\subsection{Hàm loss tổng thể}
...
% ==========================================================
\section{Bài tập được giao trong bài ANN9}
...
\subsection{Gợi ý hàm không lồi}
...
\subsection{Gradient tổng quát cho hàm hai biến}
...
\subsection{Ý nghĩa của việc tự lập trình}
...
% ==========================================================
\section{Pseudocode cho ba phương pháp}

\subsection{Pseudocode SGD}
...
\subsection{Pseudocode Batch Gradient Descent}
...
\subsection{Pseudocode Mini-batch Gradient Descent}
...
\subsection*{Bài tập 1: Tính số iteration}
...
\subsection*{Bài tập 2: Nhận diện phương pháp}
...
\subsection*{Bài tập 3: So sánh ưu nhược điểm}
...
\subsection*{Bài tập 4: Bài tập lập trình theo yêu cầu}
