...
% ==========================================================
\section{Softmax in Classification -- Bối cảnh: Softmax trong bài toán phân loại}
...
\subsection{Ví dụ hệ thống phân loại ảnh lớn}
...
% ==========================================================
\section{Two Types of Classifiers -- Hai kiểu bộ phân loại}

\subsection{Bộ phân loại thông thường}
...
\subsection{Bộ phân loại dựa trên xác suất}
...
% ==========================================================
\section{One-hot Encoding -- One-hot Encoding}

\subsection{Vì sao cần mã hóa nhãn?}
...
\subsection{Bảng one-hot encoding}
...
% ==========================================================
\section{Raw Network Output Issue -- Vấn đề ở output thô của mạng}

\subsection{Vector logits}
...
% ==========================================================
\section{Softmax Function -- Hàm Softmax}
...
\subsection{Vì sao softmax tạo ra xác suất?}
...
% ==========================================================
\section{Softmax Calculation Example -- Ví dụ tính Softmax}

\subsection{Dữ liệu ví dụ}
...
\subsection{Bước 1: Tính các giá trị mũ}
...
\subsection{Bước 2: Tính mẫu số chung}
...
\subsection{Bước 3: Tính từng xác suất}
...
% ==========================================================
\section{Softmax \& Argmax -- Softmax và Argmax}
...
\subsection{Argmax dưới dạng one-hot}
...
\subsection{Softmax xấp xỉ argmax theo nghĩa mềm}
...
% ==========================================================
\section{Why \"Softmax\"? -- Vì sao gọi là Softmax?}

\subsection{Ý nghĩa tên gọi}
...
\subsection{Max cứng và softmax mềm}
...
% ==========================================================
\section{Key Softmax Properties -- Tính chất quan trọng của Softmax}

\subsection{Tính chất 1: Output luôn dương}
...
\subsection{Tính chất 2: Tổng output bằng 1}
...
\subsection{Tính chất 3: Giữ thứ tự tương đối}
...
\subsection{Tính chất 4: Khuếch đại sự khác biệt}
...
% ==========================================================
\section{Softmax at Output Layer -- Softmax ở lớp output của mạng nơ-ron}

\subsection{Quy trình trong bài toán phân loại}
...
\subsection{Dự đoán class cuối cùng}
...
% ==========================================================
\section{Softmax \& Cross Entropy -- Softmax và Cross Entropy}

\subsection{Vì sao softmax thường đi cùng cross entropy?}
...
% ==========================================================
\section{Softmax Computation Notes -- Lưu ý khi tính Softmax}

\subsection{Vấn đề số quá lớn}
...
\subsection{Cách ổn định số học}
...
\subsection{Vì sao không thay đổi?}
...
\subsection*{Bài tập 1: Tính softmax}
...
\subsection*{Bài tập 2: Xác định class dự đoán}
...
\subsection*{Bài tập 3: One-hot vector}
...
\subsection*{Bài tập 4: Cross entropy với softmax}
...
\subsection*{Bài tập 5: Softmax ổn định số học}
