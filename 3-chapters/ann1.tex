...
% ==========================================================
\section{Artificial Neural Networks Overview -- Tổng quan về mạng nơ-ron nhân tạo}

\subsection{Mạng nơ-ron nhân tạo là gì?}
...
\subsection{ANN học từ dữ liệu như thế nào?}
...
\subsection{Tại sao ANN quan trọng?}
...
% ==========================================================
\section{ANN Applications -- Các lĩnh vực ứng dụng của ANN}
...
\subsection{Nhận dạng hình ảnh, âm thanh và video}
...
\subsection{Dự đoán chuỗi thời gian}
...
\subsection{Y khoa, giáo dục và kinh doanh}
...
% ==========================================================
\section{Supervised Learning \& Data Collection -- Học có giám sát và quá trình thu thập dữ liệu}

\subsection{Khái niệm học có giám sát}
...
\subsection{Ví dụ: điều khiển thiết bị bằng sóng não}
...
% ==========================================================
\section{From Biological to Artificial Neurons -- Từ nơ-ron sinh học đến nơ-ron nhân tạo}
...
\subsection{Ý nghĩa của trọng số}
...
% ==========================================================
\section{Activation Functions -- Hàm kích hoạt}

\subsection{Vai trò của hàm kích hoạt}
...
\subsection{So sánh sigmoid và tanh}
...
% ==========================================================
\section{Parameters, Hyperparameters \& Training -- Tham số, siêu tham số và huấn luyện mạng}

\subsection{Tham số của mô hình}
...
\subsection{Huấn luyện mạng là gì?}
...
\subsection{Model sau khi huấn luyện}
...
% ==========================================================
\section{Neural Network Architecture -- Cấu trúc mạng nơ-ron}

\subsection{Lớp input, lớp ẩn và lớp output}
...
\subsection{Mạng truyền thẳng nhiều lớp}
...
% ==========================================================
\section{Example 1: Stock Price Prediction -- Ví dụ 1: Dự đoán giá cổ phiếu}
...
\subsection{Mạng nơ-ron cho bài toán}
...
% ==========================================================
\section{Example 2: Self-Driving Car -- Ví dụ 2: Xe tự lái}
...
\subsection{Mô hình học những gì được dạy}
...
% ==========================================================
\section{Example 3: Cat \& Dog Classification -- Ví dụ 3: Nhận dạng chó và mèo từ ảnh}
...
\subsection{Vì sao đây là bài toán phi tuyến?}
...
\subsection{Sơ đồ tư duy ngắn gọn}
...
\subsection*{Bài tập 1: Tính output của nơ-ron}
...
\subsection*{Bài tập 2: Xác định input và output}
