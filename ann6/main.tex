...
% =========================
\title{
    \textbf{Tài liệu học tập ANN6}\\
    \large Giải chi tiết ví dụ lan truyền ngược sai số
}
...
% ==========================================================
\chapter*{Mục tiêu của tài liệu}
\addcontentsline{toc}{chapter}{Mục tiêu của tài liệu}
...
\section{Cấu trúc mạng trong ví dụ}
...
% ==========================================================
\chapter{Tính xuôi trong ví dụ}

\section{Tính output của hidden neuron $h_1$}
...
\section{Tính output của hidden neuron $h_2$}
...
% ==========================================================
\chapter{Tính sai số của ví dụ}

\section{Sai số tại output $o_1$}
...
% ==========================================================
\chapter{Cập nhật các trọng số lớp output}

\section{Cập nhật $w_5$}
...
\section{Bảng kết quả cập nhật lớp output}
...
% ==========================================================
\chapter{Cập nhật bias ở lớp output}

\section{Bias ứng với output $o_1$}
...
\section{Bias ứng với output $o_2$}
...
% ==========================================================
\chapter{Cập nhật các trọng số phía trước}

\section{Điểm quan trọng khi tính $w_1$}
...
\section{Sơ đồ đúng khi tính đạo hàm theo $w_1$}
...
\section{Tính $\frac{\partial E_{total}}{\partial out_{h_1}}$}
...
% ==========================================================
\chapter{Cập nhật $w_3$ và $w_4$}

\section{Tính ảnh hưởng qua hidden neuron $h_2$}
...
\section{Bảng kết quả cập nhật lớp hidden}
...
% ==========================================================
\chapter{Cập nhật bias ở lớp hidden}

\section{Bias ứng với $h_1$}
...
% ==========================================================
\chapter{Tổng kết một lượt cập nhật}

\section{Bảng trọng số trước và sau cập nhật}
...
\section{Bảng bias trước và sau cập nhật}
...
\section{Ý nghĩa của một lượt cập nhật}
...
% ==========================================================
\chapter{Những lỗi dễ mắc trong ví dụ}

\section{Lỗi 1: Chỉ tính một nhánh khi cập nhật $w_1$}
...
\section{Lỗi 2: Nhầm dấu khi cập nhật}
...
\section{Lỗi 3: Dùng nhầm output của neuron}
...
% ==========================================================
\chapter{Bài tập tự kiểm tra theo ví dụ}

\section*{Bài tập 1: Kiểm tra sai số tổng}
...
\section*{Bài tập 2: Tính lại $w_5^{new}$}
...
\section*{Bài tập 3: Vì sao $w_7$ tăng?}
...
\section*{Bài tập 4: Viết đúng biểu thức cho $w_1$}
