...
% =========================
\title{
    \textbf{Tài liệu học tập ANN4}\\
    \large Tối ưu hóa, Gradient Descent và lựa chọn hàm mất mát
}
...
% ==========================================================
\chapter{Nhắc lại quá trình huấn luyện mạng nơ-ron}

\section{Từ dữ liệu đến sai số}
...
% ==========================================================
\chapter{Huấn luyện ANN là một bài toán tối ưu}

\section{Bản chất của quá trình huấn luyện}
...
\section{Không phải lúc nào cũng có lời giải giải tích}
...
% ==========================================================
\chapter{Gradient Descent trong trường hợp một biến}

\section{Bài toán minh họa}
...
\section{Đạo hàm cho biết hướng đi}
...
% ==========================================================
\chapter{Learning rate}

\section{Learning rate là gì?}
...
\section{Learning rate thay đổi theo thời gian}
...
% ==========================================================
\chapter{Gradient Descent trong bài toán nhiều biến}

\section{Từ đạo hàm sang gradient}
...
\section{Công thức cập nhật tổng quát}
...
\section{Liên hệ với backpropagation}
...
\section{Ví dụ cập nhật một trọng số}
...
% ==========================================================
\chapter{Cực trị địa phương và cực trị toàn cục}

\section{Cực trị toàn cục}
...
\section{Vấn đề mắc kẹt ở cực trị địa phương}
...
\section{Ảnh hưởng trong huấn luyện ANN}
...
% ==========================================================
\chapter{Exploration và Exploitation}

\section{Exploitation là gì?}
...
\section{Cân bằng exploration và exploitation}
...
% ==========================================================
\chapter{Thuật toán di truyền và metaheuristic}

\section{Metaheuristic là gì?}
...
% ==========================================================
\chapter{Momentum và ý tưởng vượt cực trị địa  - local minimum}

\section{Hạn chế của Gradient Descent cơ bản}
...
\section{Không đảm bảo tìm được cực trị toàn cục}
...
% ==========================================================
\chapter{Lựa chọn hàm mất mát}

\section{Các hàm mất mát phổ biến}
...
\section{Vì sao cross entropy thường tốt cho phân loại?}
...
\section{Không có hàm mất mát tốt nhất cho mọi bài toán}
...
% ==========================================================
\chapter{So sánh các khái niệm quan trọng}

\section{Backpropagation và Gradient Descent}
...
\section{Local minimum và global minimum}
...
\section*{Bài tập 1: Gradient Descent một biến}
...
\section*{Bài tập 2: Cập nhật trọng số}
...
\section*{Bài tập 3: So sánh learning rate}
...
\section*{Bài tập 4: Tính cross entropy}
...
\section*{Bài tập 5: Nhận diện loại bài toán}
