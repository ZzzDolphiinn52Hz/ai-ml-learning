...
% =========================
\title{
    \textbf{Tài liệu học tập ANN3}\\
    \large Huấn luyện mạng nơ-ron, lan truyền ngược và hàm mất mát
}
...
% ==========================================================
\chapter{Nhắc lại bài toán học có giám sát}

\section{Mạng nơ-ron cần học ánh xạ}
...
\section{Dữ liệu trong học có giám sát}
...
% ==========================================================
\chapter{Thông số ban đầu của mạng nơ-ron}

\section{Tham số của từng nơ-ron}
...
\section{Mạng có rất nhiều tham số}
...
\section{Vì sao output ban đầu thường sai?}
...
% ==========================================================
\chapter{Lan truyền tiến}

\section{Ý tưởng của lan truyền tiến}
...
\section{Lan truyền tiến qua nhiều lớp}
...
% ==========================================================
\chapter{Sai số và ý tưởng huấn luyện}

\section{So sánh output dự đoán với output mong muốn}
...
\section{Huấn luyện là giảm sai số}
...
% ==========================================================
\chapter{Lan truyền ngược sai số}

\section{Backpropagation là gì?}
...
\section{Liên hệ với điều khiển tự động}
...
% ==========================================================
\chapter{Quá trình huấn luyện lặp}

\section{Huấn luyện qua từng mẫu}
...
\section{Vì sao cần lặp nhiều lần?}
...
% ==========================================================
\chapter{Bài toán phân loại nhiều lớp}

\section{Khái niệm class}
...
\section{Thiết kế output cho bài toán nhiều lớp}
...
\section{Output dự đoán của mạng}
...
% ==========================================================
\chapter{Đo sai số giữa hai vector}

\section{Vì sao cần đo sai số giữa hai vector?}
...
% ==========================================================
\chapter{Hàm mất mát dựa trên chuẩn L2 - NORM 2}

\section{Chuẩn L2 của vector}
...
\section{Sai số L2 giữa hai vector}
...
% ==========================================================
\chapter{Đo khác biệt bằng góc giữa hai vector}
...
\section{Ý tưởng của cross entropy}
...
\section{Cross entropy với one-hot label}
...
\section{Ví dụ tính cross entropy}
...
\section{So sánh các cách đo sai số}
...
% ==========================================================
\chapter{Mô hình học được những gì?}

\section{Mô hình chỉ học trong phạm vi dữ liệu được dạy}
...
\section{Số lượng class trong các bộ dữ liệu lớn}
...
\section{Không phải cứ huấn luyện là thành công}
...
% ==========================================================
\chapter{Tổng hợp quy trình huấn luyện ANN}
...
\section*{Bài tập 1: One-hot encoding}
...
\section*{Bài tập 2: Tính chuẩn L2}
...
\section*{Bài tập 3: Tính cross entropy}
...
\section*{Bài tập 4: Xác định output layer}
